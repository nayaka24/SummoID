...
<head>
    ...
    <title>Tambah Penginapan  | Summo</title>
                                        ...
                                        <div class="row">
                                            <div class="review-content-section">
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nama Penginapan" name="nama" id="nama">
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Jumlah Kamar" name="jumlah" id="jumlah">
                                                </div>
                                            </div>
                                            <div class="review-content-section">

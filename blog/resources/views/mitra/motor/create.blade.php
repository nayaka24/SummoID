...
<head>
    ...
    <title>Tambah Kendaraan | Summo</title>
                                        ...
                                        <div class="row">
                                            <div class="review-content-section">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <select class="form-control" name="kategori">
                                                        <option value="" holder>Pilih Kategori Kendaraan</option>
                                            ...
                                            <div class="review-content-section">
                                                <div class="input-group">
                                                    ...
                                                    <textarea name= "deskripsi" placeholder="Deskripsi" class="form-control" id="isi" rows="10"></textarea>
                                                </div>
                                            </div>
                                        </div><br>
                                    </div>

...
<head>
    ...
    <title>Edit Paket Wisata  | Summo</title>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" value ="{{$Wisata->nama}}" placeholder="Nama Objek Wisata" name="nama" id="nama">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" value ="{{$Wisata->handphone}}"placeholder="+628xxxxxxxx" name="handphone" id="handphone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea placeholder="Deskripsi" class="form-control" id="deskripsi" name="deskripsi" rows="10">{{$Wisata->deskripsi}}</textarea>
                                                      </div>
                                                </div>
                                            </div>
                                        </div>

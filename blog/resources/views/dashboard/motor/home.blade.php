...
<head>
    ...
    <title>List Kendaraann | Summo</title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <tr>
                                    ...
                                    <td><a href="{{asset ('bike/stnk/'.$hasil->stnk)}}" target="_blank" rel="noopener norefrrer">Lihat Gambar</a></td>
                                    <td>{{$hasil->nama}}</td>
                                    <td>{{$hasil->harga}}</td>
                                    ...
                                    <td>{{$hasil->users->name}}</td>
                                        ...
                                        @endif
                                    <td>
                                    <form action="{{url ('/motors-admin/'.$hasil->id_motor)}}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ url ('/motors-admin/'. $hasil->id_motor .'/edit')}}" class ="pd-setting-ed" data-toggle="tooltip" title ="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

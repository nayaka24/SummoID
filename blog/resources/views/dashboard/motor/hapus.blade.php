...
<head>
    ...
    <title>List Hapus Kendaraan | Summo</title>
                            ...
                            @foreach($Motor as $result =>$hasil)
                                <tr>
                                    ...
                                    <form action="{{url ('/motors/'.$hasil->id_motor.'/kill')}}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ url ('/motors/'. $hasil->id_motor .'/restore')}}" class ="btn btn-primary" data-toggle="tooltip" title="Restore">Restore</a>

                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description">Berita</a></li>
                                    <li><a href="#reviews">Gambar</a></li>
                                </ul>
                                <form action="{{url ('/beritas/'.$News->id_berita)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img">
                                                                <img src="assets/img/berita/dis.jpg" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="product-edt-pix-wrap">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="file" class="form-control" placeholder="Pilih Gambar" name="gambar" id="gambar" value="{{$News->gambar}}"> 
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

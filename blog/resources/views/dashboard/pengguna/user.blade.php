                            ...
                            <table>
                                ...
                                @if($hasil->level == 'user')
                                    <tr>
                                        ...
                                        <td><a href="{{asset ('pengguna/'. $user -> gambar) }}" target="_blank" rel="noopener norefrrer">Lihat Gambar</a></td></td>
                                        <td>{{$hasil->nama}}</td>
                                        <td>{{$hasil->email}}</td>
                                        <td>{{$hasil->password}}</td>
                                        <td>{{$hasil->handphone}}</td>
                                        <td>
                                        <form action="{{url ('/pengguna/'.$hasil->id_user)}}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ url ('/pengguna/'. $hasil->id_user .'/edit')}}" class ="pd-setting-ed" data-toggle="tooltip" title ="edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

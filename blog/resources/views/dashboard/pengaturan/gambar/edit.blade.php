                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active" ><a href="#reviews">Gambar</a></li>
                                </ul>
                                <form action="{{url ('/gambar/'.$Image->id_gmbr)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="row">
                                                        ...
                                                        <textarea name= "isi" placeholder="Keterangan Gambar" class="form-control" id="exampleFormControlTextarea1" rows="10">{{$Image->isi}}</textarea>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img">
                                                                <img src="{{asset ('image/'.$Image->gambar)}}" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
